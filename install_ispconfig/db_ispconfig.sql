...
INSERT INTO `doctype` (`doctype_id`, `userid`, `groupid`, `doctype_modul`, `doctype_name`, `doctype_title`, `doctype_def`, `doctype_tree`) VALUES (1024, 1, 1, 'sys', 'monitor', 'ISP �erwachung', '', 0);
