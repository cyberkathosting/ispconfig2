...
CREATE TABLE `isp_isp_reseller` (
  ...
  `limit_mysql_space` varchar(255) default NULL,
  PRIMARY KEY  (`doc_id`),
  KEY `doctype_id` (`doctype_id`)
) TYPE=MyISAM;
...
CREATE TABLE `isp_isp_web` (
  ...
  `web_mysql_space` varchar(255) default NULL,
  `web_mysql_space_exceeded` enum('N','Y') NOT NULL default 'N',
  `web_mysql_space_used_fract` float NOT NULL default '0',
  PRIMARY KEY  (`doc_id`),
  KEY `doctype_id` (`doctype_id`)
) TYPE=MyISAM;
