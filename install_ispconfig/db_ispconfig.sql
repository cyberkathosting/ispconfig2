...
CREATE TABLE `dns_isp_dns` (
  ...
  `dns_allow_transfer` varchar(255) default NULL,  
  PRIMARY KEY  (`doc_id`),
  KEY `doctype_id` (`doctype_id`)
) TYPE=MyISAM;
